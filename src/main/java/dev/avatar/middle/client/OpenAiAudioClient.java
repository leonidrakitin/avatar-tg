...
public class OpenAiAudioClient {
	 ...
	 */
	public OpenAiAudioClient(String openAiToken) {
	 ...
	 */
	public OpenAiAudioClient(String baseUrl, String openAiToken, RestClient.Builder restClientBuilder) {
	...
	public static void main(String[] args) throws IOException {
		...
		var audioApi = new OpenAiAudioClient(System.getenv("OPENAI_API_KEY"));
