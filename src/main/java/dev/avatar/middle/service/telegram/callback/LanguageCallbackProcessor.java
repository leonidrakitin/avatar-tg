...
@Slf4j
@Component
public class LanguageCallbackProcessor extends TelegramCallbackProcessor {
    ...
    public LanguageCallbackProcessor(
    ...
    public void process(TelegramBot bot, CallbackQuery callback) {
        ...
        Language languageCode = Language.valueOf(callback.data());
